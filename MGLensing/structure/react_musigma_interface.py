...
class MuSigmaReACT():
    ...
    def __init__(self, option=None):
        ...
        self.kh_tot_hmcode = np.concatenate((self.kh_lin_left_hmcode, self.kh_nl_hmcode))
    ...
    def get_pk_nl_interp(self, params_dic):
        ...
        mg_boost_left = np.ones((self.nz_pk, len(self.kh_lin_left_boost)))
        ...
        mg_boost_interp = RectBivariateSpline(self.zz_pk,
                    ...
                    mg_boost_k,
                    kx=1, ky=1)
        mg_plin_interp = RectBivariateSpline(self.zz_pk,
                    self.kh_lin,
                    mg_pk_lin,
                    kx=1, ky=1)
    ...
    def get_pk_hmcode_interp(self, params_dic):
        ...
        plin_left = plin_cp[:, self.kh_lin_hmcode<self.kh_nl_hmcode[0]]
    ...
    def get_growth(self, params_dic, zz_integr):
        ...
        mu0 = params_dic['mu0'] 
        mu0_arr = 1.+mu0/e2*omega_lambda/(1.-omega_m)
        #mu0_arr = 1.+mu0/e2
