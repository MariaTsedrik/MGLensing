...
class MuSigmaQ123ReACT():
    ...
    def __init__(self, option=None):
        ...
        print('initialising Scale-independent mu-Sigma Parametrisation')
        ...
        print('initialising ReACT scale-indep mu')
        self.emu_name = 'ReACT mu-Sigma-q123-z'
